...
if (typeof NProgress != 'undefined') {
	...
	function init_JQVmap(){
		...
		console.log('init_JQVmap');
			...
			if ($('#asia-map-gdp').length ){
		 
				$('#asia-map-gdp').vectorMap({
					map: 'asia_en',
			...
			if ($('#mainb').length ){
				  ...
				  echartBar.setOption({
					...
					series: [{
					  name: 'Frequency',
					  type: 'bar',
					  data: [120, 34, 150, 78, 20, 180, 20, 260, 90, 10, 250, 40],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: 'Higest Frequency'
						}]
					  },
					  markLine: {
						data: [{
			...
			if ($('#echart_line').length ){ 
			  ...
			  echartLine.setOption({
				...
				series: [{
				  ...
				  data: [22, 30, 40, 36, 33, 21, 20, 19, 25, 30, 19, 20]
				}, {
				  name: 'Hauler',
				  type: 'line',
				  smooth: true,
				  ...
				  data: [20, 20, 25, 23, 40, 41, 38, 35, 33, 27, 30, 18]
				}]
			  });
			...
			if ($('#echart_line1').length ){ 
			  ...
			  echartLine.setOption({
				...
				series: [{
				  ...
				  data: [14, 13, 15, 17, 20, 22, 24, 16, 18, 14, 12, 18]
				}, {*/
				  name: 'Hauler',
				  type: 'line',
				  smooth: true,
				  ...
				  data: [16, 18, 20, 22, 22, 19, 18, 20, 22, 17, 15, 15]
				}]
			  });
			...
			if ($('#echart_line2').length ){ 
			  ...
			  echartLine.setOption({
				...
				series: [{
				  ...
				  data: [2000, 1230, 2500, 2730, 3600, 3300, 3356, 4567, 2400, 2415, 2311, 1980]
				}, {
				  name: 'Hauler',
				  type: 'line',
				  smooth: true,
				  ...
				  data: [1600, 1800, 2032, 2243, 2212, 1956, 1878, 2067, 2290, 1790, 1578, 1545]
				}]
			  });
			...
			if ($('#echart_line3').length ){ 
			  ...
			  echartLine.setOption({
				...
				series: [{
				  ...
				  data: [30, 35, 40, 45, 30, 20, 39, 43, 23, 28, 32, 34]
				}, {
				  name: 'Hauler',
				  type: 'line',
				  smooth: true,
				  ...
				  data: [30, 34, 30, 35, 29, 36, 45, 50, 44, 34, 45, 30]
				}]
			  });
			...
			if ($('#echart_line4').length ){ 
			  ...
			  echartLine.setOption({
				...
				series: [{
				  ...
				  data: [300000, 310000, 210000, 250000, 309000, 220000, 240000, 160000, 200000, 141200, 123900, 180000]
				}, {
				  name: 'Hauler',
				  type: 'line',
				  smooth: true,
				  ...
				  data: [161231, 188977, 201213, 228976, 221212, 193989, 180991, 205678, 229898, 171281, 151213, 159000]
				}]
			  });
